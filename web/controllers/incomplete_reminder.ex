defmodule PitchIn.IncompleteReminder do
  @moduledoc """
  ...
  defp page_to_complete(conn, user) do
    if user.is_staffer do
      ...
      {
        "campaign",
        PitchIn.Router.Helpers.campaign_path(conn, :edit, campaign_id),
        PitchIn.Router.Helpers.campaign_path(conn, :update, campaign_id),
        PitchIn.Router.Helpers.campaign_path(conn, :interstitial, campaign_id),
       }
    else
      {
        "profile",
